  ...
  <swiper class="about" :options="swiperOption" ref="mySwiper">
    <swiper-slide class="swiper-item">
      ...
      <div class="item-right">
        <div class="profile-title-en">Craftsmanship creates quality life products</div>
        <div class="profile-title-cn">匠心筑就智慧人居精品</div>
        <div class="profile-text">
          <p>实地集团，2006年从广州出发，始于地产而不止于地产。13年来，实地一直致力于将人类科技的一切探索创新以人居业态为依托运用于生活中的方方面面，
            将科技与人文连接，重新构建人类对于自身与居住空间关系的认知。目前，实地集团已经发展成为一家为用户提供贯穿全生命周期智慧人居解决方案的综合性企业。</p>
          <p>实地集团现已覆盖全国六大最具成长力城市群，在26城全面绽放。每落子一地，均从区域先天资源的统筹观出发，开发每个城市的独特魅力，
            探索每个城市的人文价值，创造与之匹配的智能生活解决方案，为每座城市打造专属的人居经典。</p>
          <p>实地集团坚持用户至上原则，关注每一个个体的真实需求。从项目规划之初，就从用户痛点出发，以科技创新的产品思维先行，借助智能产品、数据分析、生活配套三位一体的服务体系，
            满足用户对居住环境安全、家庭健康、时间管理、情感交互等多维度的需求,以此为主线来逐步构建SLS (Smart Life System)智慧人居系统，为用户打造美好生活体验的同时，
            引领行业发展方向，提升城市整体的人居品质。</p>
        </div>
      </div>
    ...
    <swiper-slide class="swiper-item">
      ...
      <div class="item-right-ideal">
        <div class="ideal-btn">
          <div :class="{idealBtn:true,active:render}" @click="render = true">实地文化 [Culture]
            <div :class="'ideal-push-'+index" v-for="index in 4" :key="index">+</div>
          </div>
          <div :class="{idealBtn:true,active:!render}" @click="render = false">实地愿景 [Vision]
            <div :class="'ideal-push-'+index" v-for="index in 4" :key="index">+</div>
          </div>
        </div>
    ...
    <swiper-slide class="swiper-item">
      ...
      <div class="item-right-glory">
        <div class="glory-left">Seedland credentials 集团荣誉</div>
        <ul class="glory-right">
          <li>2017年、2018年</li>
          <p>连续两年入选国务院发展研究中心企业研究所、清华大学房地产研究所、中国指数研究院-中国房地产公司品牌价值TOP30、中国房地产住宅开发专业领先品牌价值TOP10 –智慧人居</p>
          <li>2018年</li>
          <p>中国房地产业协会-中国房地产开发企业100强、中国房地产开发企业品牌价值华南10强</p>
          <li>2018年</li>
          <p>新浪乐居  年度品牌创新科技奖</p>
          <li>2018年</li>
          <p>时代周报  年度产品创新奖</p>
          ...
          <p>人民网  年度实力品牌企业</p>
          <li>2019 年</li>
          <p>国务院发展研究中心企业研究所、清华大学房地产研究所、中国指数研究院联合发布-中国房地产百强企业</p>
          <p>观点指数研究院-房地产卓越100榜</p>
          <p>亿翰智库-中国房地产品牌价值TOP100、中国房地产企业粤港澳大湾区竞争力TOP20、中国房地产企业品牌价值成长性二十强、中国房地产企业品牌运营能力二十强</p>
          <p>观点指数研究院-中国年度科技地产领军企业</p>
          <p>♦实地 · 武汉君兰汀岸</p>
          <p>2017年环球设计第1601期推荐项目</p>
          <p>♦实地 · 三亚海棠华著</p>
          <p>意大利A’Design Award室内空间和展览类金奖</p>
          <p>♦实地 · 遵义蔷薇国际</p>
          <p>遵义地产十年地标楼盘</p>
          <p>♦ 实地 · 天津海棠雅著</p>
          <p>意大利A’Design Award室内空间和展览类银奖</p>
          <p>红棉中国设计奖 年度室内设计至尊奖</p>
          <p>2017年金盘奖 年度最佳售楼空间</p>
          <p>♦实地 · 广州常春藤</p>
          <p>2016年、2018年先后两次通过BREEAM英国绿色建筑评估认证荣获广州区域首个全球杰出先驱奖</p>
          <p>2018年荣获新浪乐居 年度智慧人居奖</p>
          <p>2018年获网易新闻&广东省地产商会中国地产冠军榜年度人气明星楼盘</p>
          <p>2017年度中国地产冠军榜 年度品质精工楼盘</p>
          <p>♦实地 · 广州蔷薇国际</p>
          <p>意大利A’Design Award室内空间和展览类银奖</p>
          <p>2017中国房产风云榜年度品质楼盘</p>
          <p>2017年获克尔瑞 广州楼盘销售面积TOP10</p>
          <p>2017年获微博 十大房地产创新营销项目类（广东）</p>
          <p>2018年获网易房产&广东省地产商会中国地产冠军榜十大畅销红盘（广州）</p>
        </ul>
      </div>
      <div class="item-footer">
        <div class="footer-left">
...
export default {
  ...
  data(){
    return{
      ...
      render:true,
      idealText1:[{title:'万物向阳 实地生长',text:'<p>我们认为,生活就像是一颗种子，需要阳光、水分、土壤、空气的用心滋养，只有不断去灌溉培育，精心呵护，才能让种子茁壮成长，生活才会变得更加美好幸福。</p><p>实地集团将为孕育人们美好生活的种子提供养分与能量，扶植他们破土发芽，生根向阳，去向更美好的地方。</p>'}],
      idealText2:[{title:'打造美好人居生活体验',text:'<p>人类文明的繁衍传承来自于外在两大驱力的推动，即科技创新与人文关怀。二者互为促进，互为支撑。实地集团坚持用户至上原则，始终秉承初心，关注每一个个体的真实需求，锲而不舍的创新只为提升生活品质。勇者不囿于现状，而智者尤擅于超越。实地相信，唯有不拘传统、锐意进取、持续迭代，才能在未来人居体验的探索道路上，创造匠心铸就的精品。</p>'}]
    }
  },
  watch:{
    render(){
  ...
  .swiper-item{
    ...
    .item-footer{
      ...
      .footer-right{
        ...
        .footer-frame.next:hover{
          background-color: rgb(82, 82, 82)
        }
        .footer-prev:hover{
          background-color: rgb(82, 82, 82)
        }
        .footer-frame.next.prev{
          margin-right: 0;
          .arrow{
